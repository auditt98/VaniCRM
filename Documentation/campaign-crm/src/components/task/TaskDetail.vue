    ...
    <div class="px-5 pt-3 m-0 background-main" style="position: relative">
      ...
      <div class="row ">
        ...
        <div class="col-sm-4 d-flex justify-content-between">
          ...
          <router-link :to="{name: 'TaskUpdate', query: {id: task.id}}"><VButton :data="btnEdit"/></router-link>
        </div>
      </div>
      <div class="row mt-3">
        <div class="col-sm-2">
        ...
        <div class="col-sm-10">
          <div class="row">
            <UserInfo ref="userTags" :tags="task.tags" :image="'x'" :title="'Tags'" @create-tag="createTag" />
          </div>
